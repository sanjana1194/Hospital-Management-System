...
function generate_bill(){
  ...
  while($row = mysqli_fetch_array($query)){
    $output .= '
    <label> Bill No : </label>MNM_'.$row["pid"].$row["ID"].'<br/><br/>
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">    
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-hospital-o" aria-hidden="true"></i> MNM</a>
...
.btn-primary{
  ...
  <div class="col-md-4" style="max-width:25%; margin-top: 3%">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" href="symptom_checker.php">Find Specialist</a>
                  ...
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      ...
                      <p class="links cl-effect-1">
                            <a href="admin-panel.php#list-home" class="btn btn-primary mt-2" onclick="clickDiv('#list-home-list')">Book Appointment</a>
                ...
                <div class="col-sm-4" style="left: 10%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                      ...
                      <p class="cl-effect-1">
                            <a href="admin-panel.php#list-history" class="btn btn-primary mt-2" onclick="clickDiv('#list-pat-list')">View Appointment History</a>
            ...
            <div class="row">
                <div class="col-sm-4" style="left: 5%;margin-top:5%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                      ...
                      <p class="cl-effect-1">
                            <a href="admin-panel.php#list-prescription" class="btn btn-primary mt-2" onclick="clickDiv('#list-pres-list')">View Prescription List</a>
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-sm-4" style="left: 10%;margin-top:5%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                      <span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-paperclip fa-stack-1x fa-inverse"></i> </span>
                      <h4 class="StepTitle" style="margin-top: 5%;">Find Specialist</h2>
                    
                      <p class="cl-effect-1">
                        <a href="symptom_checker.php" class="btn btn-primary mt-2">Check Symptoms</a>
                      </p>
                    </div>
                  </div>
                </div>
...
<div class="tab-pane fade" id="list-find-doc" role="tabpanel" aria-labelledby="list-find-doc-list">
  <div class="container-fluid">
    <div class="card">
      <div class="card-body">
        <center><h4>Find Specialist Based on Symptom</h4></center><br>

        <form method="post" action="">
          <div class="form-group">
            <label for="symptom">Enter Symptom:</label>
            <input type="text" name="symptom" class="form-control" placeholder="e.g., cough, chest pain" required>
          </div>
          <br>
          <button type="submit" class="btn btn-primary">Check Specialist</button>
        </form>
        ...
        <?php
          if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['symptom'])) {
              ...
              if ($con) {
                  $query = "SELECT specialization FROM symptom_specialization WHERE LOWER(symptom) = '$symptom' LIMIT 1";
                  $result = mysqli_query($con, $query);

                  echo '<div class="alert alert-info">';
                  if (mysqli_num_rows($result) > 0) {
                      $row = mysqli_fetch_assoc($result);
                      echo "You should consult a <strong>" . htmlspecialchars($row['specialization']) . "</strong>.";
                  } else {
                      echo "No matching specialization found. Please consult a <strong>General Physician</strong>.";
                  }
                  echo '</div>';
              } else {
