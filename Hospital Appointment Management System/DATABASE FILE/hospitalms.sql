...
INSERT INTO `doctb` (`username`, `password`, `doctorname`, `email`, `spec`, `docFees`) VALUES
('deepa', 'deepa123', 'Chris Olivas', 'deepa@gmail.com', 'Oncologist', 580);
...
-- 2. Insert common symptom-specialization mappings
INSERT INTO symptom_specialization (symptom, specialization) VALUES
...
('stomach upset', 'Gastroenterologist'),
...
('geriatric care', 'Geriatrician'),
('Dizziness, Vertigo', 'Neurologist or ENT Specialist'),
('Weight Loss, Loss of Appetite', 'Oncologist or Gastroenterologist'),
('Frequent Urination, Thirst', 'Endocrinologist'),
('Hearing Loss, Tinnitus', 'Audiologist or ENT Specialist'),
('Abdominal Pain, Bloating', 'Gastroenterologist'),
('Mood Swings, Fatigue', 'Psychiatrist'),
('Vision Changes, Eye Pain', 'Ophthalmologist'),
('Swollen Lymph Nodes, Fever', 'Infectious Disease Specialist'),
('Cold Sores, Mouth Ulcers', 'Dentist or Oral Surgeon'),
('Numbness, Tingling', 'Neurologist'),
('Nausea, Vomiting', 'Gastroenterologist'),
...
('Pain, Limited Mobility, Stiffness, Muscle Weakness, Swelling, Fatigue', 'Physiotherapist'),
('Digestive Issues', 'Gastroenterologist'),
('Anxiety, Depression', 'Psychiatrist');

UPDATE doctb
SET spec = 'General Physician'
WHERE doctorname = 'Radhi';
