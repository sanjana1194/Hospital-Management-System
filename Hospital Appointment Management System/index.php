...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" >
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="#" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-hospital-o" aria-hidden="true"></i>&nbsp MNM</h4></a>
...
<img src="https://cdn-icons-png.flaticon.com/512/4320/4320337.png" alt="Hospital Icon" style="width: 150px; height: auto; margin-bottom: 20px;" />
                        <h3>Welcome</h3>
